...
PROJECT GROUP: 
    ...
    2. Justin Heng  | justinheng@csu.fullerton.edu   | Graduate  
```
...
- **`GUIDELINES`** -------------- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/CPSC483ClassProjectInstructions.pdf)*
- **`PROPOSAL`** ----------------- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/proposal/CPSC483-MLProjectProposal.pdf)*
- **`GITHUB REPOSITORY`** ----- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction)*
- **`JUPYTER NOTEBOOK`** ------ *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/2-CPSC483-ClassProject-Submission/Crab-Age-Prediction-JupyterNotebook.ipynb)*
- **`PAPER`** --------------------- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/paper/Crab%20Age%20Prediction%20Paper.pdf)*
- **`PRESENTATION`** ----------- *[`Click Here`](https://youtu.be/2IMGdeu2SMg)*


|   |   |
| :- | :- |
| **`PROJECT ~ GUIDELINES`** | *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/CPSC483ClassProjectInstructions.pdf)* |
| **`PROJECT ~ PROPOSAL`** | *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/proposal/CPSC483-MLProjectProposal.pdf)* |
| **`PROJECT ~ GITHUB REPOSITORY`** | *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction)* |
| **`PROJECT ~ JUPYTER NOTEBOOK`** | *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/2-CPSC483-ClassProject-Submission/Crab-Age-Prediction-JupyterNotebook.ipynb)* |
| **`PROJECT ~ PAPER`** | *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/paper/Crab%20Age%20Prediction%20Paper.pdf)* |
| **`PROJECT ~ PRESENTATION`** | *[`Click Here`](https://youtu.be/2IMGdeu2SMg)* |

| CLASS SUBMISSION  |
| ----------------- | 
| **`GUIDELINES`** -------------- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/CPSC483ClassProjectInstructions.pdf)* <br /> **`PROPOSAL`** ----------------- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/proposal/CPSC483-MLProjectProposal.pdf)* <br /> **`GITHUB REPOSITORY`** ----- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction)* <br /> **`JUPYTER NOTEBOOK`** ------ *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/2-CPSC483-ClassProject-Submission/Crab-Age-Prediction-JupyterNotebook.ipynb)* <br /> **`PAPER`** --------------------- *[`Click Here`](https://github.com/13rianlucero/CrabAgePrediction/blob/main/1-CPSC483-ClassProject-Development/paper/Crab%20Age%20Prediction%20Paper.pdf)* <br /> **`PRESENTATION`** ----------- *[`Click Here`](https://youtu.be/2IMGdeu2SMg)* |
...
![DIAGRAM](https://raw.githubusercontent.com/13rianlucero/CrabAgePrediction/main/images/PREDICTION_SYSTEM_WORKFLOW_DIAGRAM.jpeg)
